...
<head>
    ...
    <title> {{ env('APP_NAME', 'Webmall') }} - login to your accout </title>
        ...
        <div class="flex flex-row w-full">
            ...
            <div class='hidden lg:flex flex-col justify-between bg-[#ffe85c] lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg'>
                ...
                <div class='space-y-5'>
                    ...
                    <a href="{{ route('login', ['domain' => 'client']) }}"
            ...
            <div class="flex flex-1 flex-col items-center justify-center px-10 relative">
                ...
                <div class="flex lg:hidden justify-between items-center w-full py-4">
                    ...
                    <div class="flex items-center space-x-2">
                        ...
                        <a href="{{ route('login', ['domain' => 'client']) }}" class="underline font-medium text-[#070eff]">
                            Sign in now
                        </a>
                    </div>
                </div>
                ...
                <div class="flex flex-1 flex-col  justify-center space-y-5 max-w-md">
                    ...
                    <form id="register_form" class="flex flex-col max-w-md space-y-5" x-data="loginData">
                        @csrf
                        <input type="text" name="name" x-bind="errorBiner" placeholder="name"
                            class="flex px-3 py-2 md:px-4 md:py-3 border-2  rounded-lg font-medium placeholder:font-normal" />
                        <span class="text-red-500 font-semibold ml-2 !mt-0"></span>
                        
                        <input type="text" name="email" x-bind="errorBiner" placeholder="email"
                            class="flex px-3 py-2 md:px-4 md:py-3 border-2 border-black rounded-lg font-medium placeholder:font-normal" />
                        <span class="text-red-500 font-semibold ml-2 !mt-0"></span>

                        
                        <input type="password" name="password" x-bind="errorBiner" placeholder="password"
                            class="flex px-3 py-2 md:px-4 md:py-3 border-2 border-black rounded-lg font-medium placeholder:font-normal" />
                        <span class="text-red-500 font-semibold ml-2 !mt-0"></span>

                        
                        <input type="password" name="password_confirmation" x-bind="errorBiner" placeholder="password confirmation"
                            class="flex px-3 py-2 md:px-4 md:py-3 border-2 border-black rounded-lg font-medium placeholder:font-normal" />
                        <span class="text-red-500 font-semibold ml-2 !mt-0"></span>

                        <button @click="tryRegister()" x-bind:disabled="disabled" id="loginBtn" data-post-url="{{ route('register', ['domain' => 'client']) }}"
                            class="flex h-12 relative disabled:bg-gray-700 items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black bg-black text-white">
                            <span x-show="!disabled">create an account</span>
                            <div x-show="disabled"
                            class="inline-block left-1/2 absolute h-8 w-8 animate-spin rounded-full border-4 border-solid border-current border-e-transparent align-[-0.125em] text-surface motion-reduce:animate-[spin_1.5s_linear_infinite] dark:text-white"
                            role="status">
                            <span
                        ...
                        <a href="{{ route('social.redirect', ['service' => 'google', 'domain'=> 'client']) }}"
                        ...
                        <a href="{{ route('social.redirect', ['service' => 'fb', 'domain'=> 'client']) }}"
                            class="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-lg font-medium border-black relative">
                            <span class="absolute left-4">
                                <i class="bi bi-facebook text-2xl flex items-center text-sky-700"></i>
                            </span>
