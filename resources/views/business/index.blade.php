...
<header class="min-h-fit bg-white ">
   ...
   <div class="md:flex space-x-16 mt-20 md:mr-0 mr-10">
     <div class="md:flex items-center pl-16 ">
       <div class="">
         <h class="lg:text-5xl  font-bold leading-tight text-3xl">Brow Your Shop To Internet world And Grow Your Clients</h1>
           <p class="mt-4 text-lg font-normal ">create yur shop, share your products, see previews, build a comunity,<br> build strong stratigy from our analytic tools
             <br> and many more .</p>
           <div
             class="flex mt-10 w-40 items-center space-x-3 py-3 px-6 bg-indigo-600 text-white rounded-lg  transition-all duration-400 transform hover:scale-105 cursor-pointer hover:shadow-lg">
             <a href="{{ route('business.create') }}" class="text-lg text-md whitespace-nowrap">Start now</a>
             <span>
     ...
     <!-- Box right -->
     <div class="min-w-[500px] pr-24 md:flex justify-center items-center  hidden">
       <img class="rounded-lg w-full h-full" src="{{ asset('./assets/images/business.png') }}" alt="">
     </div>
   </div>

   <!--Show Brand -->
   <div class="hidden lg:block">
     <ul class="flex mt-28 space-x-36 justify-center">
